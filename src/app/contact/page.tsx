...
export default function ContactForm() {
  ...
  return (
    <section className="min-h-[calc(100vh-80px)] flex-column items-center justify-center px-6 bg-gradient-to-b from-[#050209] via-[#0a0512] to-[#120a1f] w-full max-w-2x1 py-32 md:py-40 px-6 md:px-4">
