...
export function SkillSection() {
  ...
  return (
    <section className="min-h-screnn mb:min-h-[calc(100vh-80px)] py-24 md:py-12">
      <h2 className="text-3xl  font-bold mb-12 items-center text-[#c95bf5]">{t.home.skillset}</h2>
      ...
      {skills.length > initialMobileSkills && (
        <div className="md:hidden mt-8 flex justify-center">
          ...
          >
            {showAllSkillsMobile
              ? t.skill['show-less-button']
              : `${t.skill['show-more-button']} +${skills.length - initialMobileSkills}`}
          </button>
        </div>
      )}
    </section>
