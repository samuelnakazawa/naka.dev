...
export function HeroSection() {
  ...
  return (
    <section className="animate-fade-in mx-auto mb-16 max-w-6xl pt-16">
      <div className="flex flex-col items-center gap-6 md:flex-row md:items-start md:gap-12">
        <div className="relative aspect-square w-full max-w-[352px] shrink-0 md:order-2 md:aspect-auto md:h-64 md:w-64 lg:h-72 lg:w-72">
        ...
        <div className="flex-1 space-y-8 md:order-1">
          <h1 className="text-2xl font-bold leading-tight text-[#f0e9ff] sm:text-3xl md:text-5xl">
