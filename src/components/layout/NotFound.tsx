    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#0f0524] to-[#251240] p-4 text-white">
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center justify-center gap-8 md:flex-row">
        <div className="animate-slide-in-left text-center md:text-left">
          <h1 className="animate-pulse-subtle mb-4 bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 bg-clip-text text-8xl font-bold text-transparent md:text-9xl">
            404
          </h1>
      ...
      <div className="animate-fade-in-delayed absolute bottom-2 text-sm text-white">
        {t('error')}
      </div>
    </div>
  );
